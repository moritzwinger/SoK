...
EXPECT_THROW(mvp_from_diagonals(vector(dim, vec()), v
...
{
EXPECT_EQ(perfect_square(49),
true);
EXPECT_EQ(perfect_square(16123 * 16123),
true);
EXPECT_EQ(perfect_square(7 * 5),
false);
EXPECT_EQ(perfect_square(929 * 941),
false);
}
